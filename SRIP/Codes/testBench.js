...
function selectImage() {
    'use strict';
    var inputImCanvas = document.getElementById("inputImCanvas"), inputImCanvasCtx = inputImCanvas.getContext("2d");
    ...
    $("#mosaicSelectImage").imgAreaSelect({
        ...
        onSelectEnd: function (img, selection) {
            ...
            inputImCanvasCtx.drawImage(img, Math.round(selection.x1 * scaleFactor), Math.round(selection.y1 * scaleFactor), Math.round(selection.width * scaleFactor), Math.round(selection.height * scaleFactor), 0, 0, inputImCanvas.width, inputImCanvas.height);
